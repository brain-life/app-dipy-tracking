...
def load_files():
    ...
    Data_path = collections.namedtuple("Data_path", ['data_path', 'data_file', 'data_fs_seg', 'data_bval', 'data_bvec'])
    d = Data_path(data_path=config['data_path'], data_file=config['data_file'], data_fs_seg=config['data_fs_seg'], data_bval=config['data_bval'], data_bvec=config['data_bvec'])
    ...
    #Data = collections.namedtuple("Data", ['data_bvec', 'data_bval'])
    #d = Data(data_bvec=data_bvec, data_bval=data_bval)
